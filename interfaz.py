...
class Interfaz(QMainWindow):
    def __init__(self):
        ...
        self.atributo1=QLabel("atributo 1")
        self.atributo2=QLabel("atributo 2")
        self.atributo3=QLabel("atributo 3")
        self.atributo4=QLabel("atributo 4")
        self.atributo5=QLabel("atributo 5")
        self.atributo6=QLabel("atributo 6")
